import { CSSProperties, css, getStyleStringUnit } from "../style";
...
export function tip(
  ...
  const {
    ...
    diff = position === TipPosition.Left || position === TipPosition.Right
      ? 0.5
      : 0.5,
    x = "0px",
    y = "0px",
  ...
  style && content.setAttribute("style", content.style.cssText + css(style));
