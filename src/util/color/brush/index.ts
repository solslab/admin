import type { CSSProperties } from "@util/style";
...
export namespace __Brush {
  ...
  export class BrushInstance {
    ...
    public setColor(
      color: Palette.HarmonyNameType,
      level: Palette.HarmonyLevelType,
    ) {
    ...
    public setUsage(
      arg:
        | { color?: boolean; backgroundColor?: boolean; borderColor?: boolean }
        | true,
    ) {
      const {
        color = true,
    ...
    public build(origin?: CSSProperties) {
      ...
      return Object.assign(
        ...
        this._reverse
          ? {
              backgroundColor: this._usage.backgroundColor
                ? colorSet.color
                : undefined,
              color: this._usage.color ? colorSet.backgroundColor : undefined,
              borderColor: this._usage.borderColor
