...
import { Palette } from "../";
import { __Raw, __Var } from "./colors";

export namespace __Palette {
  export namespace Color {
    export import Scss = __Var;
    export import ValueRaw = __Raw;
  }
  ...
  export function scssFix(
    color: HarmonyNameType,
    shade: ShadeType | number,
    themeGlobal: "white" | "g100" = "g100",
  ) {
    const fixedShade = themeGlobal === "g100" ? 2600 - shade : shade;
    return `var(--hq-${color}-${fixedShade < 1000 ? "0" + fixedShade : fixedShade})`;
  }
    ...
    return {
      normal: {
        ...
        hover: {
          ...
          backgroundColor: scss(
            harmonyName,
            (bgShade + 100 + bgAdditional) as ShadeType,
          ),
          borderColor: scss(
            harmonyName,
            (bgShade + 400 + bgAdditional) as ShadeType,
          ),
        },
        active: {
          color: scss(harmonyName, colorShade),
          backgroundColor: scss(
            harmonyName,
            (bgShade + 200 + bgAdditional) as ShadeType,
          ),
          borderColor: scss(
            harmonyName,
            (bgShade + 500 + bgAdditional) as ShadeType,
          ),
        },
      },
      ...
      dard: {
        ...
        active: {
          ...
          backgroundColor: scss(
            harmonyName,
            (bgShade + 300 + bgAdditional) as ShadeType,
          ),
          borderColor: scss(
            harmonyName,
            (bgShade + 600 + bgAdditional) as ShadeType,
          ),
        },
      },
      ...
      deep: {
        ...
        active: {
          ...
          borderColor: scss(
            harmonyName,
            (bgShade + 700 + bgAdditional) as ShadeType,
          ),
        },
      },
    };
    ...
    return {
      normal: {
        ...
        hover: {
          ...
          backgroundColor: scss(
            hormonyName,
            (bgShade + 100 + bgAdditinal) as ShadeType,
          ),
          borderColor: scss(
            hormonyName,
            (bgShade + 400 + bgAdditinal) as ShadeType,
          ),
        },
        active: {
          color: scss(hormonyName, colorShade),
          backgroundColor: scss(
            hormonyName,
            (bgShade + 200 + bgAdditinal) as ShadeType,
          ),
          borderColor: scss(
            hormonyName,
            (bgShade + 500 + bgAdditinal) as ShadeType,
          ),
        },
      },
      ...
      dard: {
        ...
        active: {
          ...
          backgroundColor: scss(
            hormonyName,
            (bgShade + 300 + bgAdditinal) as ShadeType,
          ),
          borderColor: scss(
            hormonyName,
            (bgShade + 600 + bgAdditinal) as ShadeType,
          ),
        },
      },
      ...
      deep: {
        ...
        active: {
          ...
          borderColor: scss(
            hormonyName,
            (bgShade + 700 + bgAdditinal) as ShadeType,
          ),
        },
      },
    };
  ...
  export namespace Delta {
    export function getHarmonyName(delta?: number) {
      return (
        !delta ? "base" : delta > 0 ? "ocean-green" : "imperial-red"
      ) as HarmonyNameType;
    }
  }
  ...
  export namespace Paint {
    ...
    export function from(arg: {
      ...
      return (
        paint?.color ||
        (harmonyName && harmonyShade && scss(harmonyName, harmonyShade))
      );
    }
  ...
  export namespace Preset {
    ...
    export const legendPaint: Palette.Paint.Prop = {
      harmonyName: "base",
      harmonyShade: 1700,
    };
    ...
    export function getCommissionPaint(comm: string | number) {
      ...
      if (commission >= 0.15) {
        return Palette.Paint.get("rossa-red", 1700);
      } else {
        return Palette.Paint.get("base", 2300);
      }
    }
  }
  ...
  export namespace Vote {
    ...
    export const depositPeriod = Harmonies.get(
      harmonyName.depositPeriod,
      "Lv3",
    );
